...
//----------------------------------------------------------------------------------
Light CreateLight(int type, Vector3 position, Vector3 target, Vector4 color, Shader shader);   // Create a light and get shader locations
...
void UpdateLightValues(Shader shader, Light light)
{
    ...
    float color[4] = { light.color.x, light.color.y,
